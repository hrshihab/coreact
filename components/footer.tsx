...
const footerLinks = {
  Technology: [
    { label: "Quantum Dots", href: "#technology" },
    { label: "Applications", href: "#applications" },
    { label: "Materials", href: "#" },
  ],
  Company: [
    { label: "About Coreact", href: "#" },
    { label: "Research", href: "#" },
    { label: "Careers", href: "#" },
  ],
  Legal: [
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-8">
          <div className="col-span-2 sm:col-span-1">
            ...
            <p className="text-xs sm:text-sm text-muted-foreground">Engineering the future of quantum dot technology.</p>
          </div>
        ...
        <div className="mt-8 sm:mt-12 pt-4 sm:pt-6 border-t border-border flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-[10px] sm:text-xs text-muted-foreground">
            &copy; {new Date().getFullYear()} Coreact. All rights reserved.
          </p>
