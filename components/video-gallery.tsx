...
const demos = [
  {
    title: "QD Synthesis",
    description: "Advanced quantum dot material fabrication",
    Illustration: LiveChatIllustration,
  },
  {
    title: "Optical Characterization",
    description: "Precision analysis of quantum dot properties",
    Illustration: TicketResolutionIllustration,
  },
  {
    title: "Application Integration",
    description: "Quantum dots in real-world devices",
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold tracking-display mb-4">
            Quantum dots <span className="text-gradient-lime">in action</span>
          </h2>
          <p className="text-sm sm:text-base text-muted-foreground max-w-xl mx-auto">
            From synthesis to integration - see our advanced nanotechnology at work
          </p>
        </motion.div>
